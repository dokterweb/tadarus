@extends('layouts.app')
@section('content_title','Laporan Sabaq')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('sabaqs.laporan') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
...
<script>
    $(document).ready(function () {
        ...
        $('#openPdf').on('click', function() {
            ...
            var url = "{{ route('sabaqs.laporan') }}?start_date=" + start_date + "&end_date=" + end_date + "&pdf=true";
        ...
        $('#exportExcel').on('click', function() {
            ...
            var url = "{{ route('sabaqs.export') }}?start_date=" + start_date + "&end_date=" + end_date;
