@extends('layouts.app')
@section('content_title','Laporan manzil')

@section('content')
    <div class="card">
        <div class="card-body">
            <form id="filterForm" method="GET" action="{{ route('manzils.laporan') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
...
<script>
    $(document).ready(function () {
        ...
        $('#openPdf').on('click', function() {
            ...
            var url = "{{ route('manzils.laporan') }}?start_date=" + start_date + "&end_date=" + end_date + "&pdf=true";
         ...
         $('#exportExcel').on('click', function() {
            ...
            var url = "{{ route('manzils.export') }}?start_date=" + start_date + "&end_date=" + end_date;
