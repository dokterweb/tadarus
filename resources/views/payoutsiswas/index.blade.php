...
<div class="card card-danger">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('payoutsiswas.filter_bulanans') }}">
            @csrf
            <div class="row">
                <div class="col-md-5">
            ...
            <tbody>
                @if(count($bulanans) > 0)
                    <tr>
                        ...
                        <td><a href="{{route('payoutsiswas.tagihan_bulan',['payment' => $bulanans[0]->payment_id, 'siswa' => $bulanans[0]->siswa_id])}}" class="btn btn-sm btn-info"><i class="far fa-edit"></i> Bayar</a></td>
                    </tr>
                @else
                    <tr>
