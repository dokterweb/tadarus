    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="paketTable" class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($sabqis as $index => $sabqi)
                        @foreach ($sabqi->sabqiHistories as $history)
                            <tr>
                                <td>{{ $index + 1 }}</td>
 ...
 <div class="modal fade" id="tambahHafalanModal" tabindex="-1" role="dialog" aria-labelledby="tambahHafalanModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="formTambahHafalan" method="POST" action="{{ route('sabqi.store') }}">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_sabqi" class="form-control" required>
                                <input type="hidden" name="sabqi_id" value="{{ $sabqi_id }}">
