@extends('layouts.app')
@section('content_title','Jenis Iqra')
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-primary">
                ...
                <form method="POST" action="{{route('jenisiqros.store')}}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label >Nama Iqro</label>
                            <input type="text" name="nama_iqro" class="form-control">
                        </div>
                    </div>
        ...
        <div class="col-md-8">
            <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">List Iqro</h3>
                </div>
                <div class="card-body">
                    <table id="paketTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @forelse ($jenisiqros as $p)
                            <tr>
                                <td>{{$loop->iteration}}</td>
                                <td>{{$p->nama_iqro}} </td>
                                <td class="d-flex align-items-center" style="gap: 5px;">
                                   <a href="{{route('jenisiqros.edit',$p->id)}}" class="btn btn-sm btn-info"><i class="far fa-edit"></i></a>
